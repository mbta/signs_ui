...
const formSchema = object().shape({
  items: array().of(
    object().shape({
      ...
      non_platform_text_line1: string().nullable().when('non_platform_text_enabled', {
        is: true,
        then: string().required(),
      }),
      non_platform_text_line2: string().nullable(),
    }),
  ),
});
          ...
          {({
            ...
            >
              ...
              <div>
                ...
                { !readOnly && (
                  <div>
                    <button className="mr-2" id="apply" type="submit" disabled={!dirty || !isValid}>Apply</button>
                    {isEnabled && (
                      <button
                        id="disable"
                        type="button"
