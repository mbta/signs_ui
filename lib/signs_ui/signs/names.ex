defmodule SignsUI.Signs.Names do
  ...
  def red_line() do
    [
      ...
      {"jfk_umass_ashmont_platform_southbound", "Red JFK/UMass (Ashmont Platform) Southbound"},
      {"jfk_umass_braintree_platform_southbound", "Red JFK/UMass (Braintree Platform) Southbound"},
      {"jfk_umass_ashmont_platform_northbound", "Red JFK/UMass (Ashmont Platform) Northbound"},
      {"jfk_umass_braintree_platform_northbound", "Red JFK/UMass (Braintree Platform) Northbound"},
