defmodule SignsUI.Signs.Names do
  ...
  def orange_line() do
    [
      ...
      {"malden_center_entire_station_northbound", "Malden Center Entire Station Northbound"},
      {"malden_center_entire_station_southbound", "Malden Center Entire Station Southbound"},
      ...
      {"orange_north_station_commuter_rail_exit_northbound", "Orange North Station Commuter Rail Exit Northbound"},
      {"orange_north_station_commuter_rail_exit_southbound", "Orange North Station Commuter Rail Exit Southbound"},
      ...
      {"ruggles_upper_busway_northbound", "Ruggles Upper Busway Northbound"},
      {"ruggles_upper_busway_southbound", "Ruggles Upper Busway Southbound"}
    ]
  end
  ...
  def red_line() do
    [
      ...
      {"south_station_silver_line_arrival_platform_northbound", "South Station Silver Line Arrival Platform Northbound"},
      {"south_station_silver_line_arrival_platform_southbound", "South Station Silver Line Arrival Platform Southbound"},
